...
rs.debug_info = function(debug_x, debug_y)
	...
	love.graphics.printf(
		rs._NAME
			.. " v."
			.. tostring(rs._VERSION)
			.. "\n"
			.. "game_width: "
			.. tostring(rs.game_width)
			.. "\n"
			.. "game_height: "
			.. tostring(rs.game_height)
			.. "\n"
			.. "scale_width: "
			.. tostring(rs.scale_width)
			.. "\n"
			.. "scale_height: "
			.. tostring(rs.scale_height)
			.. "\n"
			.. "scale_mode: "
			.. tostring(rs.scale_mode)
			.. "\n"
			.. "x_offset: "
			.. tostring(rs.x_offset)
			.. "\n"
			.. "y_offset: "
			.. tostring(rs.y_offset)
			.. "\n",
		debug_x,
		debug_y,
		debug_width
